...
# Input Hotkey Block
- GUID:              `com.deathweasel.bepinex.i
...
# KKS_Fix Camera Mask Resize
- Short description: Fixes an issue where color masks don't resize when changing the resolution in maker addint a letter box effect to character/game.
- Author(s):         https://github.com/IllusionMods         
- More information:  https://github.com/IllusionMods/IllusionFixes
